...
class BitmapEjercicio(imagen:ImageView): AsyncTask<Int?, Void?, Bitmap?>()  {

    // protected Bitmap doInBackground(Integer... params) {
    // protected void onPostExecute(Bitmap bitmap) {
    private val imageViewReference: WeakReference<ImageView?> = WeakReference(imagen)
    ...
    override fun doInBackground(vararg params: Int?): Bitmap? {
        ...
        Log.d("BitmapEjercicio", "Mostrando imagen...")
        return try {
